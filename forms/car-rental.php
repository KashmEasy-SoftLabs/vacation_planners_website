...
if (isset($_POST['submit-modal'])) {
    ...
    $sql = "INSERT INTO car_rentals (name, email, phone, carToBook, message) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssss", $name, $email, $phone, $carToBook, $message);
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'New Car Booking';
            $mail->Body = "Name: $name<br>Email: $email<br>Phone: $phone<br>Car To Book: $carToBook<br>Message: $message";
